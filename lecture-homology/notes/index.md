...
next_lecture: lecture-msa/notes
---
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/globins-lemur.jpg" alt="Ring-tailed lemur beta globin">
    <div class="figure-caption">Ring-tailed lemur beta globin structure</div>
</div>

<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/globins-goldfish.jpg" alt="Goldfish beta globin">
    <div class="figure-caption">Goldfish beta globin structure</div>
</div>

<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/globins-soybeans.jpg" alt="Soybean leghemoglobin">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/dotplot.png" alt="Dot plot visualization">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/match_probs.png" alt="Match probabilities">
    <div class="figure-caption">Variation of match/mismatch probabilities with evolutionary distance \(d = \mu t\)</div>
</div>

<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/match_scores.png" alt="Match scores">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/gap_penalty.svg" alt="Gap penalty illustration">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/optimality1.svg" alt="Principle of optimality">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/smith_waterman.svg" alt="Smith-Waterman illustration">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/smith_waterman_example.png" alt="Smith-Waterman example">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/repeated_match_example.png" alt="Repeated match example">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-homology/notes/overlap_match_example.png" alt="Overlap match example">
