...
previous_lecture: lecture-substitution-models/notes
next_lecture: lecture-bayesian-phylogenetics/notes
---
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/dice_inference.svg" alt="Bayesian dice inference" style="width: 80%;">
...
<div class="example-box">
    <h4>Setup</h4>
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/urn.svg" alt="Urn with colored balls" style="float: right; width: 30%;">
    <ul>
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/urn_posterior.png" alt="Posterior distribution for urn problem" style="width: 70%;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/poissonian.png" alt="Poisson distributions" style="width: 40%;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/uniform_improper.png" alt="Improper uniform prior" style="width: 80%;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/lognormal.png" alt="Log-normal distributions" style="width: 80%;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/credible_interval.png" alt="95% credible interval" style="width: 80%;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/MonteCarlo.jpg" alt="Monte Carlo simulation" style="width: 60%;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/rejection_sampling1.svg" alt="Rejection sampling" style="width: 70%;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/curse.svg" alt="Curse of dimensionality" style="width: 40%; float: right;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/MCMC6.svg" alt="MCMC random walk" style="width: 70%;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/MCMC_trace.png" alt="MCMC trace" style="width: 45%; display: inline-block;">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/MCMC_density.png" alt="MCMC density" style="width: 45%; display: inline-block;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/MCMC_burnin.svg" alt="MCMC burn-in" style="width: 80%;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/MCMC_convergence_testing.png" alt="Convergence testing" style="width: 50%;">
...
<div class="figure">
    <img src="{{ site.baseurl }}/lecture-bayesian-inference/MCMC_acf.png" alt="Autocorrelation function" style="width: 80%;">
