...
\centering
$T = \textcolor{darkgreen}{\vec{\mu}} \star \textcolor{red}{g}$
...
\begin{tikzpicture}[xscale=0.5,yscale=-0.5]
  \node[anchor=north, line width=1.25pt] at (236.66667pt, 108.8889pt) {B};
  \node[anchor=north, line width=1.25pt] at (190pt, 140pt) {A};
  \draw[line width=1.25pt] (236.66667pt, 108.8889pt) -- (236.66667pt, 77.77778pt) -- (213.33333pt, 77.77778pt);
  \draw[line width=1.25pt] (190pt, 140pt) --  (190pt, 77.77778pt) -- (213.33333pt, 77.77778pt);
  \node[anchor=north, line width=1.25pt] at (283.33334pt, 84pt) {C};
  \draw[line width=1.25pt] (213.33333pt, 77.77778pt) --  (213.33333pt, 46.66667pt) -- (248.33333pt, 46.66667pt);
  \draw[line width=1.25pt] (283.33333pt, 84pt) -- (283.33333pt, 46.66667pt) -- (248.33333pt, 46.66667pt);
  \node[anchor=north, line width=1.25pt] at (330pt, 70pt) {D};
  \draw[line width=1.25pt] (248.33333pt, 46.66667pt) -- (248.33333pt, 0pt) -- (289.16667pt, 0pt);
  \draw[line width=1.25pt] (330pt, 70pt) -- (330pt, 0pt) -- (289.16667pt, 0pt);
...
$=\textcolor{darkgreen}{\begin{pmatrix}0.01\\0.005\\0.004\\0.005\\0.01\\0.01\end{pmatrix}}\star$
...
\begin{tikzpicture}[yscale=-0.5,xscale=0.5]
  ...
  \draw[dash pattern=on 1.0 off 1.0 ] (-14pt, 77.77778pt) -- (154pt, 77.77778pt);
  
  \node[red,anchor=west, dash pattern=on 1.0 off 1.0 ] at (154pt, 77.77778pt) {\scriptsize{20.0}};
  ...
  \draw[line width=1.25pt,red] (0pt, 140pt) -- (0pt, 77.77778pt) -- (23.33333pt, 77.77778pt);
  \node[anchor=east, line width=1.25pt] at (0pt, 124.44444pt) {\scriptsize{1}};
  \draw[line width=1.25pt,red] (46.66667pt, 140pt) -- (46.66667pt, 77.77778pt) -- (23.33333pt, 77.77778pt);
  ...
  \draw[line width=1.25pt,red] (23.33333pt, 77.77778pt) -- (23.33333pt, 46.66667pt) -- (58.33333pt, 46.66667pt);
  \node[anchor=east, line width=1.25pt] at (23.33333pt, 60pt) {\scriptsize{5}};
  ...
  \node[anchor=east, line width=1.25pt] at (140pt, 60pt) {\scriptsize{4}};
\end{tikzpicture}
